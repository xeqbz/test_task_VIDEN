...
from src.load import write_jsonl
...
def main() -> None:
    ...
    # load_to_bigquery_stub(normalized_rows, settings) could be called here
    # after importing it from src.load and configuring real BigQuery credentials.
